...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/xfirsty/script/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/xfirsty/permission/main/ip"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/xfirsty/script/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
function noobzvpn(){
clear
wget --no-check-certificate https://raw.githubusercontent.com/xfirsty/script/main/noobzvpns.zip
unzip noobzvpns.zip
cd noobzvpns
bash install.sh
rm noobzvpns.zip
...
cd
    ...
    wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/xfirsty/script/main/encrypt/encrypt" ; chmod +x /usr/bin/enc
    7z x -p@xfirsty menu.zip
    chmod +x menu/*
    enc menu/*
